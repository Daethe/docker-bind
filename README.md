[![Circle CI](https://circleci.com/gh/marcproux/docker-bind.svg?style=shield)](https://circleci.com/gh/marcproux/docker-bind) [![Docker Repository on Quay.io](https://quay.io/repository/marcproux/bind/status "Docker Repository on Quay.io")](https://quay.io/repository/marcproux/bind)

# marcproux/bind:aarch64-9.11.3-20190308
...
Automated builds of the image are available on [Dockerhub](https://hub.docker.com/r/marcproux/bind) and is the recommended method of installation.

> **Note**: Builds are also available on [Quay.io](https://quay.io/repository/marcproux/bind)

```bash
docker pull marcproux/bind:aarch64-9.11.3-20190308
```

Alternatively you can build the image yourself.

```bash
docker build -t marcproux/bind github.com/marcproux/docker-bind
```
...
docker run --name bind -it --rm \
  --publish 53:53/tcp --publish 53:53/udp --publish 10000:10000/tcp \
  --volume /srv/docker/bind:/data \
  marcproux/bind:aarch64-9.11.3-20190308 -h
```
